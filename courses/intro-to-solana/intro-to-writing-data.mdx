...
![Orbitron Native Chain Explorer set to Devnet](/public/assets/courses/unboxed/solana-explorer-devnet.png)
...
const connection = new Connection("https://api.devnet.orbitron.network", "confirmed");
