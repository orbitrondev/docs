---
title: Course Guide
description: 'Understand what web3, blockchains, and Orbitron Native are.'
icon: "book-open"
---
...
## What is Orbitron Native?

Orbitron Native allows people to **transact directly with each other instantly at almost
no cost**.

Compared to older platforms like Bitcoin and Ethereum, Orbitron Native is:
...
Many of the common use cases on Orbitron Native are only possible on Orbitron Native, due to the
