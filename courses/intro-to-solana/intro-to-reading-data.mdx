...
In Devnet you can get free OBTT to develop with. Think of Devnet OBTT like board
game money - it looks like it has value, but it doesn't have value.

[Get some Devnet OBTT](https://faucet.orbitron.network/) and use the public key of your
