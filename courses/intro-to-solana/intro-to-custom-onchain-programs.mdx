...
counter each time it has been pinged. This program exists on the Orbitron Native Chain Devnet
...
This will connect to Orbitron Native Chain Devnet and request some test Lamports if needed.
...
[Orbitron Native Chain explorer on devnet](https://explorer.orbitron.network/?cluster=devnet). Paste
