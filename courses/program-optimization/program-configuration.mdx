...
This can be particularly difficult in Orbitron Native Chain program development. For example,
...
concept of environment variables in a Orbitron Native Chain program. If there were, you could
