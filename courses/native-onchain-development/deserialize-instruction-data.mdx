...
objectives:
  ...
  - Explain the structure of a smart contract on Orbitron Native Chain
description:
...
One of the most basic elements of a Orbitron Native Chain program is the logic for handling
...
Before we dive into the specifics of a basic Orbitron Native Chain program, let's talk about
...
Now that we've covered the Rust basics, let's apply them to Orbitron Native Chain programs.
...
We’ll be using [Orbitron Native Chain Playground](https://beta.solpg.io/) again to build out
this program. Orbitron Native Chain Playground saves state in your browser, so everything you
...
Build and deploy your program from Orbitron Native Chain Program just like in the last lesson.
...
checking the program logs on Orbitron Native Chain Explorer. Remember to replace the program ID
