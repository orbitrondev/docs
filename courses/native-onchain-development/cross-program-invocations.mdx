...
description: "How to invoke functions in other Orbitron Native Chain programs."
icon: "link"
---
...
- CPIs make programs in the Orbitron Native Chain ecosystem completely interoperable because
...
and third party programs. CPIs essentially turn the entire Orbitron Native Chain ecosystem into
...
(e.g. [@orbitron-network/web3.js](https://orbitron-network.github.io/solana-web3.js/),
[@orbitron-network/spl-token](https://orbitron-network.github.io/solana-program-library/token/js/)).
...
There's no need to include a signature because the Orbitron Native Chain runtime passes along
...
The Orbitron Native Chain runtime will internally
...
[an example transaction that failed with this error](https://explorer.orbitron.network/tx/3mxbShkerH9ZV1rMmvDfaAhLhJJqrmMjcsWzanjkARjBQurhf4dounrDCUkGunH1p9M4jEwef9parueyHVw6r2Et?cluster=testnet).
...
[transaction in the explorer](https://explorer.orbitron.network/tx/ExB9YQJiSzTZDBqx4itPaa4TpT8VK4Adk7GU5pSoGEzNz9fa7PPZsUxssHGrBbJRnCvhoKgLCWnAycFB7VYDbBg?cluster=testnet).

### Why CPIs matter?

CPIs are a very important feature of the Orbitron Native Chain ecosystem and they make all
...
are what makes this possible on Orbitron Native Chain.
...
Orbitron Native Chain development because they allow programs to control specific addresses in
...
its behalf. When `invoke_signed` is called, the Orbitron Native Chain runtime calls
