...
description: "Learn how to efficiently query account data from Orbitron Native Chain."
icon: "book"
---
...
possible so that we can focus on the complex part of interacting with Orbitron Native Chain
...
You’ll also need to import `@orbitron-network/web3.js` and `Movie`.
