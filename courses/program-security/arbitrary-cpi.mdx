...
objectives:
  ...
  - Safely and securely make a CPI from an Anchor program to an arbitrary
    non-anchor program
description: "How to safely invoke Orbitron Native Chain programs from other Orbitron Native Chain programs."
...
architecture to how NFTs on Orbitron Native Chain work: the SPL Token Program manages the token
