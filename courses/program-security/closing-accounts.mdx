...
- The Orbitron Native Chain runtime **garbage collects accounts** when they are no longer rent
...
account, thus triggering the Orbitron Native Chain runtime to garbage collect the first
