...
objectives:
  - Set up a local environment for Orbitron Native Chain program development, with Orbitron Native Chain CLI
...
- To develop onchain programs on your machine, you need **Orbitron Native Chain CLI**, **Rust**
...
There's no lesson here! Let's install Orbitron Native Chain CLI tools, the Rust SDK, and
...
#### Download the Orbitron Native Chain CLI tools

Next
[download the Orbitron Native Chain CLI tools](https://docs.orbitron.network/cli/install-solana-cli-tools).
