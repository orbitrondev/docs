...
description: "Invoke other Orbitron Native Chain programs from your Anchor app. "
icon: "anchor"
---
...
Anchor makes invoking other Orbitron Native Chain programs easier, especially if the program
...
import { getAssociatedTokenAddress, getAccount } from "@orbitron-network/spl-token"
...
You can run `npm install @orbitron-network/spl-token --save-dev` if you don't have it
installed.
